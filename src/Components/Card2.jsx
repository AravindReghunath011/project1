...
const Card2 = () => {
  return (
    <div className="w-full border border-black border-dashed relative rounded-lg overflow-hidden">
            <div className="relative h-full flex flex-col justify-end group">
              ...
              <div className="h-[80%] overflow-hidden rounded-xl transition-all duration-300 delay-0 ease-in-out group-hover:h-full ">
                <img
